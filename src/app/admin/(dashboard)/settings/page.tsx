      ...
      <div className="bg-background rounded-xl border border-border shadow-sm overflow-hidden p-6">
        <form className="space-y-8">
          ...
          <div className="flex justify-end pt-4 border-t border-border/50">
            <button type="button" className="flex items-center gap-2 bg-primary text-primary-foreground font-manrope font-bold py-3 px-8 rounded-lg hover:bg-primary/90 transition-colors">
